...
See the [Add items to a datastore guide](/deno-slack-sdk/guides/adding-items-to-a-datastore) for more information on the API method underlying this command. 
