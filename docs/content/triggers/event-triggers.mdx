...
Your app needs to have the proper scopes to use event triggers. Include these scopes within your app's [manifest](/automation/manifest). Your app also needs to be a member of any channel where you want to listen for events.
...
|------------------|----------------------|------------------------|
|`AppMentioned`| Subscribe to only the message events that mention your app or bot. | [`app_mentions:read`](/scopes/app_mentions:read) |
| `ChannelArchived`| A channel was archived. | [`channels:read`](/scopes/channels:read)     |
| `ChannelCreated`| A channel was created. | [`channels:read`](/scopes/channels:read)  |
| `ChannelDeleted`| A channel was deleted. | [`channels:read`](/scopes/channels:read)  |
| `ChannelRenamed`| A channel was renamed. | [`channels:read`](/scopes/channels:read)  |
| `ChannelShared` | A channel has been shared with an external workspace. | [`channels:read`](/scopes/channels:read) [`groups:read`](/scopes/groups:read) |
| `ChannelUnarchived`| A channel was unarchived. | [`channels:read`](/scopes/channels:read)  |
|`ChannelUnshared`| A channel has been unshared with an external workspace.      | [`channels:read`](/scopes/channels:read) [`groups:read`](/scopes/groups:read)  |
| `DndUpdated`| Do not Disturb settings changed for a member.  | [`dnd:read`](/scopes/dnd:read) |
| `EmojiChanged` | A custom emoji has been added or changed.  | [`emoji:read`](/scopes/emoji:read)      |
|`MessagePosted`| A message was sent to a channel. _A [filter](#filters) is required to listen for this event._ | [`channels:history`](/scopes/channels:history) [`groups:history`](/scopes/groups:history) [`im:read`](/scopes/im:history) [`mpim:read`](/scopes/mpim:history) |
| `MessageMetadataPosted` | Message metadata was posted.  | [`metadata.message:read`](/scopes/metadata.message:read) |
|`PinAdded`| A pin was added to a channel. | [`pins:read`](/scopes/pins:read)           |
| `PinRemoved`| A pin was removed from a channel.  | [`pins:read`](/scopes/pins:read)    |
| `ReactionAdded`| A member has added an emoji reaction.  | [`reactions:read`](/scopes/reactions:read)   |
| `ReactionRemoved`| A member removed an emoji reaction.  | [`reactions:read`](/scopes/reactions:read)       |
| `SharedChannelInviteAccepted`| A shared channel invite was accepted.    | [`conversations.connect:manage`](/scopes/conversations.connect:manage)      |
| `SharedChannelInviteApproved`| A shared channel invite was approved.  | [`conversations.connect:manage`](/scopes/conversations.connect:manage)    |
|  `SharedChannelInviteDeclined`| A shared channel invite was declined.  | [`conversations.connect:manage`](/scopes/conversations.connect:manage) |
| `SharedChannelInviteReceived`| A shared channel invite was sent to a Slack user.  | [`conversations.connect:read`](/scopes/conversations.connect:read) |
| `SharedChannelInviteRequested` | A shared channel invite was requested to be sent. | [`conversations.connect:manage`](/scopes/conversations.connect:manage) |
| `UserJoinedChannel`| A user joined a public or private channel. | [`channels:read`](/scopes/channels:read) [`groups:read`](/scopes/groups:read) |
| `UserJoinedTeam`| A new member has joined.  | [`users:read`](/scopes/users:read)         |
| `UserLeftChannel`| A user left a public or private channel.    | [`channels:read`](/scopes/channels:read) [`groups:read`](/scopes/groups:read)
...
Carefully construct a [filter](#filters) to prevent boundless behavior. If your app does get stuck in an infinite loop, you can [delete the trigger](#delete) and the behavior will cease.
...
Event triggers are not interactive. Use a [link trigger](/automation/triggers/link) to take advantage of interactivity.
