...
import Schema from "../schema/mod.js";
import { assertEquals, assertStrictEquals } from "../dev_deps.js";
...
dntShim.Deno.test("Function without input and output parameters", () => {
    ...
    assertEquals(emptyParameterObject, NoParamFunction.export().output_parameters);
});
dntShim.Deno.test("Function with input parameters but no output parameters", () => {
    ...
    assertStrictEquals(inputParameters, NoOutputParamFunction.definition.input_parameters);
    assertEquals(emptyParameterObject, NoOutputParamFunction.export().output_parameters);
});
dntShim.Deno.test("Function with output parameters but no input parameters", () => {
    ...
    assertEquals(emptyParameterObject, NoInputParamFunction.export().input_parameters);
    assertStrictEquals(outputParameters, NoInputParamFunction.definition.output_parameters);
});
