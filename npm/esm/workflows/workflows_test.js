...
import { DefineWorkflow } from "./mod.js";
...
dntShim.Deno.test("WorkflowStep export input values", () => {
    ...
    assertEquals(`${step2Inputs.channel_name}`, "test-channel-{{inputs.name}}-{{steps.0.url}}");
    assertEquals(`${step3Inputs.channel_id}`, "C123123");
    assertEquals(`${step3Inputs.message}`, "Channel Created <#{{steps.1.channel_id}}>");
});
