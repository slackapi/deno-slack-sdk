...
dntShim.Deno.test("WithUntypedObjectProxy", () => {
    ...
    assertStrictEquals(`${ctx.foo.baz.biz.buzz.wut.wut.hi.bye}`, "{{foo.baz.biz.buzz.wut.wut.hi.bye}}");
...
dntShim.Deno.test("WithUntypedObjectProxy with namespace", () => {
    ...
    assertStrictEquals(`${ctx.foo.baz.biz.buzz.wut.wut.hi.bye}`, "{{metadata.foo.baz.biz.buzz.wut.wut.hi.bye}}");
    assertStrictEquals(`Some text ${ctx.variable}`, "Some text {{metadata.variable}}");
});
