...
export function getSlackCallbackId(
  ...
  return `slack#/functions/${defineFunctionInput.callback_id}`;
}
...
const getParameterList = (fn: FunctionRecord): FunctionParameter[] => [
  ...fn?.input_parameters ?? [],
...
export function renderTypeImports(defineFunctionInput: FunctionRecord) {
